...
fviz_contrib(pca_x2, choice = "var", axes = 1, top = 10) + labs(title = "Contributions of variables to PC 1")+
  theme(plot.title = element_text(hjust = 0.5), axis.text.x = element_text(size = 13), axis.text.y = element_text(size = 13), axis.title.y = element_text(size=13))
fviz_contrib(pca_x2, choice = "var", axes = 2, top = 10) + labs(title = "Contributions of variables to PC 2")+
  theme(plot.title = element_text(hjust = 0.5), axis.text.x = element_text(size = 13), axis.text.y = element_text(size = 13), axis.title.y = element_text(size=13))
